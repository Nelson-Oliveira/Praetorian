...
{//================================================================= Error Checking ==========================================================
  byte d;
  int i=0;
  Wire.requestFrom(I2Caddress,28);                                // request 24 bytes from device 007
  
  while(Wire.available()<28)                                      // wait for entire data packet to be received
  {
  ...
  ///////////////
//  i = battvolt_msg;
//  ros::Publisher pub_battVolt( "batt_volt", &battvolt_msg);
//  nh.advertise(pub_battVolt);
//  pub_battVolt.publish(&battvolt_msg);
